...
public class TreeModelEvent extends EventObject {
     ...
     *        index values of the removed items. The indices must be in sorted
     ...
     *        the creator of the event object passes <code>this</code> for its
     *        value)
     * @param path a TreePath object that identifies the path to the parent of
     *        the modified item(s)
     * @param childIndices an array of <code>int</code> that specifies the
     ...
     *        the creator of the event object passes <code>this</code> for its
     *        value)
     * @param path a TreePath object that identifies the path to the change. In
     *        the DefaultTreeModel, this object contains an array of user-data
     *        objects, but a subclass of TreePath could use some totally
