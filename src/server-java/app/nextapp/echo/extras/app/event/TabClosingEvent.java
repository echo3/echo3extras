...
/**
 * Event describing the closing of a tab in a multi-tabbed component.
 */
public class TabClosingEvent extends EventObject {
    ...
    /**
     * Creates a new <code>TabClosingEvent</code>.
     * 
     * @param source the source of the event
     */
    public TabClosingEvent(Object source) {
        this(source, -1);
    }
     ...
     */
    public TabClosingEvent(Object source, int tabIndex) {
        super(source);
