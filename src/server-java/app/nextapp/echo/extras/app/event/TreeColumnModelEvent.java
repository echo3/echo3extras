...
/**
 * An event which describes an update to a <code>TreeColumnModel</code>
 */
public class TreeColumnModelEvent extends EventObject {
    ...
    /**
     * Creates a new <code>TreeColumnModelEvent</code>.
     *
     ...
     */
    public TreeColumnModelEvent(TreeColumnModel source, int fromIndex, int toIndex) {
        super(source);
