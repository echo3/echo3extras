...
/**
 * Model for <code>DataGrid</code> content.
 */
public interface DataGridModel 
extends Serializable {

    /**
     * Adds a listener that will be notified of model changes,
     *
    ...
    /**
     * Returns the model value at the specified coordinate.
     * 
    ...
    /**
     * Removes a listener from being notified of model changes,
     *
