...
ExtrasApp.ColorSelect.DEFAULT_VALUE_WIDTH = new EchoApp.Extent(150);
ExtrasApp.ColorSelect.DEFAULT_SATURATION_HEIGHT = new EchoApp.Extent(150);
ExtrasApp.ColorSelect.DEFAULT_HUE_WIDTH = new EchoApp.Extent(20);
